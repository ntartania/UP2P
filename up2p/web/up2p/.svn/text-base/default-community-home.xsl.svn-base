...
<h3>Quick Links</h3>
<strong><a><xsl:attribute name="href">view.jsp?up2p:community=<xsl:value-of select="$up2p-current-community-id" /></xsl:attribute>View Local Resources</a></strong><br />
<strong><a><xsl:attribute name="href">search.jsp?up2p:community=<xsl:value-of select="$up2p-current-community-id" /></xsl:attribute>Launch a Search for Resources</a></strong><br />
<strong><a><xsl:attribute name="href">create.jsp?up2p:community=<xsl:value-of select="$up2p-current-community-id" /></xsl:attribute>Create a New Resource</a></strong>
<!-- =================== Properties Table =================== -->
<h3>Properties</h3>
...
<xsl:for-each select="./supportFiles/file">
	<tr><td><strong><a>
		...
		<xsl:value-of select="substring-after(substring-after(./location, $up2p-current-community-id), '/')" />
	</a></strong></td><td>
