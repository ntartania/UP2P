...
public class PongMessage extends Message {
	 ...
	 */
	PongMessage(short port, String ipAddress, GUID hostGUID) {
		super(Message.PONG);
		init(port, ipAddress, hostGUID);
	}
	...
	public PongMessage(
		...
		String ipAddress,
		GUID hostGUID) {
		super(messageGUID, Message.PONG);
		init(port, ipAddress, hostGUID);
	}
	 ...
	 */
	public PongMessage(byte[] rawMessage, Connection originatingConnection) {
...
*/
	...
	/**
	 * get the remote host's GUID
	 * @return
	 */
	public GUID getRemoteHostGUID() {
		
		byte[] guiddata = Arrays.copyOfRange(payload, 6, 22); //hostGUID is bytes 6-22
