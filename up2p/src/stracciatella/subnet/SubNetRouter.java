...
public class SubNetRouter extends Router {
	 ...
	 */
	public SubNetRouter(ConnectionList connectionList, ConnectionData connectionData, HostCache hostCache) {
	...
	protected void routeSubNetQueryMessage(RouteMessage m) {
		...
		if(subNetIsServed(((SubNetSearchMessage)m.getMessage()).getSubNetIdentifier())) {
			...
			List<Connection> listcopy = connectionList.getActiveOutgoingConnections();
