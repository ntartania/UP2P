...
<xsl:output method="html"/>
  ...
  <xsl:template match="PhotoShare">
	...
	<table style="border: 3px solid #f80012; background-color:#ffff99;" border="0" cellpadding="7" cellspacing="0">
		<tr><th style="color: #f80012; border: 1px solid #f80012;" colspan="2">Photo Specifications</th></tr>
